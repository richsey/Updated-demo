            ...
            <div className="flex items-center gap-2">
              ...
              {profile && (
                <div className="relative" ref={menuRef}>
                  ...
                  {menuOpen && (
                    <div className="absolute right-0 mt-2 w-48 rounded-xl border border-border/60 bg-background shadow-lg z-50 overflow-hidden animate-in fade-in-0 slide-in-from-top-2 duration-150">
